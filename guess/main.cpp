...
//为方便进行串行和并行版本的性能对比，我在这里设置了一个开关。
//给出如下指令（原来指令仍能运行）
//并行
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o main_simd
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o main_simd -O1
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o main_simd -O2
//串行
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o main_serial -DMD5_SERIAL_BASELINE=1
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o main_serial -O1 -DMD5_SERIAL_BASELINE=1
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o main_serial -O2 -DMD5_SERIAL_BASELINE=1
int main()
{
    //下面代码用于测试MD5哈希的正确性
